...
`cp #{output_file} "/Users/$USER/Library/Mobile\ Documents/com~apple~CloudDocs/instagram/#{output_file}"`

#open the new file to check it out and bask in its majesty!
`open "/Users/$USER/Library/Mobile\ Documents/com~apple~CloudDocs/instagram/#{output_file}"`

#open the folder too, just for good measure (and to faciitate deleting old files)
`open /Users/$USER/Library/Mobile\ Documents/com~apple~CloudDocs/instagram/`
